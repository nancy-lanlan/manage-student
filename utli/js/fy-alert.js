...
var fyAlert = {
    ...
    setParamsFun : function(){
     ...
     createElem : function(){
        ...
        //弹框DOM
        var alertBox = $("<div id=alertKey"+fyAlertKey+" style='border-radius:10px;width:"+this.params.area[0]+";height:"+this.params.area[1]+"' class='fy-alert-box "+this.params.skin+"'></div>"); 
